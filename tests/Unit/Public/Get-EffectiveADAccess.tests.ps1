...
Describe 'Get-EffectiveADAccess' -Tag 'Unit' {
    ...
    Context 'Function Availability' {
        It 'Should exist in the module' {
            Get-Command -Name Get-EffectiveADAccess -Module $script:moduleName | Should -Not -BeNullOrEmpty
        }

        It 'Should be a function' {
            (Get-Command -Name Get-EffectiveADAccess -Module $script:moduleName).CommandType | Should -Be 'Function'
        }
    }
    ...
    Context 'Parameter Definition' {
        ...
        It 'Should have defined parameters' {
            $cmd = Get-Command -Name Get-EffectiveADAccess -Module $script:moduleName
    ...
    Context 'Help Documentation' {
        ...
        It 'Should have help documentation' {
            $help = Get-Help -Name Get-EffectiveADAccess -ErrorAction SilentlyContinue
