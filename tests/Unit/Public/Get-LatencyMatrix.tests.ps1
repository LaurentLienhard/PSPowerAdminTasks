...
Describe 'Get-LatencyMatrix' -Tag 'Unit' {

    Context 'Function Availability' {
        It 'Should exist in the module' {
            Get-Command -Name Get-LatencyMatrix -Module $script:moduleName | Should -Not -BeNullOrEmpty
        }

        It 'Should be a function' {
            (Get-Command -Name Get-LatencyMatrix -Module $script:moduleName).CommandType | Should -Be 'Function'
        }
    }
    ...
    Context 'Parameter Definition' {
        ...
        It 'Should have defined parameters' {
            $cmd = Get-Command -Name Get-LatencyMatrix -Module $script:moduleName
    ...
    Context 'Help Documentation' {
        ...
        It 'Should have help documentation' {
            $help = Get-Help -Name Get-LatencyMatrix -ErrorAction SilentlyContinue
