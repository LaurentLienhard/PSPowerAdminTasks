...
Describe 'Disable-CompromisedUser' -Tag 'Unit' {
    ...
    Context 'Function Availability' {
        It 'Should exist in the module' {
            Get-Command -Name Disable-CompromisedUser -Module $script:moduleName | Should -Not -BeNullOrEmpty
        }

        It 'Should be a function' {
            (Get-Command -Name Disable-CompromisedUser -Module $script:moduleName).CommandType | Should -Be 'Function'
        }
    }
    ...
    Context 'Parameter Definition' {
        ...
        It 'Should have defined parameters' {
            $cmd = Get-Command -Name Disable-CompromisedUser -Module $script:moduleName
    ...
    Context 'Help Documentation' {
        ...
        It 'Should have help documentation' {
            $help = Get-Help -Name Disable-CompromisedUser -ErrorAction SilentlyContinue
